...
export class StripeElements extends StripeBase {
  ...
  @stripeMethod public async createPaymentMethod(
    paymentMethodData: Stripe.CreatePaymentMethodData|undefined = this.getPaymentMethodData()
  ): Promise<Stripe.PaymentMethodResult|undefined> {
  ...
  @stripeMethod public async createSource(
    sourceData: Stripe.CreateSourceData | undefined = this.sourceData
  ): Promise<Stripe.SourceResult|undefined> {
  ...
  ): Promise<Stripe.TokenResult|undefined> {
   ...
   */
  public async submit(): Promise<StripePaymentResponse|undefined> {
   ...
   */
  private getPaymentMethodData(): Stripe.CreatePaymentMethodData|undefined {
    const type = 'card';
    const { billingDetails, paymentMethodData } = this;
    if (billingDetails) {
      return ({
        billing_details: billingDetails as Stripe.CreatePaymentMethodData['billing_details'],
        ...paymentMethodData,
        type,
